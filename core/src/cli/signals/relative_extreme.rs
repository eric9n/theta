...
pub fn run(cli: Cli) -> Result<()> {
    ...
    print_metric("otm_oi_bias", view.otm_open_interest_bias_ratio.as_ref());
...
fn build_relative_extreme_view(
    ...
    RelativeExtremeView {
        ...
        delta_skew: combine_optional_metric(
            primary.delta_skew.as_ref(),
            benchmark.delta_skew.as_ref(),
        ),
