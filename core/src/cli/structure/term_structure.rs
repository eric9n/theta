use crate::signal_service::{TermStructureRequest, ThetaSignalService};
use anyhow::Result;
use clap::Args;
...
pub struct Cli {
    ...
    #[arg(
        long,
        default_value_t = 4,
        help = "Number of upcoming expiries to analyze"
    )]
...
fn render_term_structure(view: &crate::domain::TermStructureView, json: bool) -> Result<()> {
    if json {
