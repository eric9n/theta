...
use time::{Date, Month, OffsetDateTime, PrimitiveDateTime, UtcOffset, Weekday, format_description::well_known::Rfc3339};
...
struct Cli {
    ...
    target_delta: f64,
    #[arg(long, default_value_t = 0.05, help = "Target OTM percent for skew matching")]
    ...
    #[arg(long, default_value_t = 0.05, help = "Minimum OTM percent for put/call bias OTM buckets")]
    ...
    every_seconds: u64,
    #[arg(long, help = "Only capture during US regular market hours (09:30-16:00 ET, Mon-Fri)")]
